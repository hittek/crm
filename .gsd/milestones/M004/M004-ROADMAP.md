...
- [x] **S02: WhatsApp Business (Cloud API)** `risk:high` `depends:[S01]`
  > Shipped in S01 — WhatsApp webhook handler, verification, credential storage, and send via Cloud API v19.

- [x] **S03: Facebook Messenger** `risk:high` `depends:[S01]`
  > Shipped in S01 — Messenger webhook handler, verification, credential storage, and send via Graph API v19.
