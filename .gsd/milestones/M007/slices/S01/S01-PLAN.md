...
- [ ] **T01: Audit Vercel-specific dependencies and ARM64 blockers** `est:30m`
...
- [ ] **T02: Write Dockerfile (multi-stage, linux/arm64)** `est:1h`
...
- [ ] **T03: Write docker-compose.yml (app + postgres + redis)** `est:30m`
...
- [ ] **T04: Add /api/health endpoint** `est:20m`
...
- [ ] **T05: Smoke test full stack locally** `est:45m`
