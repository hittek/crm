...
export default async function handler(req, res) {
  ...
  try {
    ...
    const chatbot = await prisma.chatbot.findUnique({
      where:  { apiKey },
      select: { id: true, organizationId: true, kbId: true, name: true, greeting: true, escalationPhrase: true, isActive: true, enabledTools: true, autoCreateContact: true, autoCreateDeal: true, defaultDealStage: true, dealTitleTemplate: true },
    })
